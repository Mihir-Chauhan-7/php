<style type="text/css">
	table th { padding: 5px; background-color: rgb(77, 77, 255); color: rgb(230, 230, 255) }
	tr:first-child th { background-color: rgb(0, 0, 77); color: rgb(230, 230, 255)  }
	table td { border-color: black; background-color: rgb(214, 214, 245); }
...
<?php
	...
	if(isset($_FILES['image']))
	{
		...
		{
			echo "<br><center><strong>Please Select jpeg File</strong></center><br>";
		}	
	}
...
{
	echo "<center><h1>Calender ".$year."</h1></center>";
